...
import SearchByClass from '../../components/searchbyClass/SearchByClass';
import SearchByKeyword from '../../components/searchbyKeyword/SearchByKeyword';
import StudentDetails from '../../components/studentsDetails/StudentDeails';
...
const StudentList = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8 px-4">
      <h1 className="py-4 w-full bg-indigo-600 text-center text-3xl font-bold text-white rounded-md shadow-md">
        Students
      </h1>
      ...
      <div className="mt-8 bg-white p-6 rounded-md shadow-lg">
        ...
        <div className="mt-8 flex justify-center">
          <button className="px-6 py-2 bg-indigo-600 text-white text-lg font-semibold rounded-md shadow-md hover:bg-indigo-700 ">
            Get Students
          </button>
        </div>
      </div>
